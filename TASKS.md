...
| 17 | Imagery — 22 driver portraits, 11 car photographs and 7 team marks from Wikimedia Commons under free licences, with a generated credits surface carrying photographer, licence and source. A reproducible sourcing pipeline in `scripts/`. **2573 tests** | ✅ 2026-09-12 · `main` (`2e9071a`) |
