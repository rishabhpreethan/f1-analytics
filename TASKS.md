...
| # | Task | Status |
|---|---|---|
| R2 | Team logos — 7 of 11 sourced; Ferrari, Cadillac, Aston Martin and Racing Bulls have no free file | partial |
...
| 12 | Compare — the plain-language charts: result mix (100% stacked, no axis), career-relative arc, places gained, finishing strip. Found and fixed a wrong `gridVsFinish` on every driver page since F4 (trap 27) and three marks that painted a value of zero. Paid for by reclaiming the retired shade-pair tokens. **2475 tests** | ✅ 2026-08-23 · `main` (`a4f3fc3`) |
| 17 | Imagery — 22 driver portraits, 11 car photographs and 7 team marks from Wikimedia Commons under free licences, with a generated credits surface carrying photographer, licence and source. A reproducible sourcing pipeline in `scripts/`. **2573 tests** | ✅ 2026-09-12 · `main` (`PENDING`) |
