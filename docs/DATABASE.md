...
**There are 26.** `CLAUDE.md` and `PLAN.md` were corrected to 25 on 2026-08-23 and need correcting again to 26; `.claude/agents/*.md` may still say "the 14 traps". This table is the
...
whole archive at once, and **trap 26 was found in F7** while building the comparison workspace's
season lens — every one of them by running a query rather than by reading this
